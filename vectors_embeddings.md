...
- Разбиение текста на смысловые единицы (токенизация)
- Приведение слов к нормальной форме (стемминг/лемматизация)
...
- Regular Expression (RE) можно использовать для этой задачи
